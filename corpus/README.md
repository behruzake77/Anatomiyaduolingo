...
**Vizual qamrov**: har bir darsda rasmli kirish slaydi + **46 ta rasmli savol** (img turi). **31 darsga kitobdan (Ahmedov I jild) kesilgan o'z rasmi** berilgan — suyaklar (25) va bo'g'imlar (6) — umumiy skelet emas, aynan o'rganilayotgan qism. **Har bir kitob rasmi raqamlangan qismlar ro'yxati bilan** keladi (masalan Atlas C1: 1-tuberculum anterius … 9-fovea dentis) — tibbiyot uchun har bir qism nomi raqam bilan ko'rsatiladi. **Topish rejimi**: ro'yxatdagi qismni bossangiz, rasm katta ochilib "№N — nomini rasmda toping" ko'rsatiladi, va rasm ostida **"Ro'yxat" tugmasi** bilan barcha raqamlangan qismlar nomi ochiladi (har bir darsda 100% ishlaydi). **4 darsda bosiladigan raqamli nishonlar** ham bor (Atlas C1, bo'yin umurtqasi, Axis C2, yelka suyagi) — nishonni bossangiz nomi ko'rinadi; uzilgan chiziqli (dashed) nishonlar taxminiy joylashuvni bildiradi (avto-aniqlangan, tekshirish talab qilinadi). Shundan **8 tasi ko'ndalang kesma (rang bilan ajratilgan)**. Har bir rasmni bosib **to'liq ekranda kattalashtirib o'qish** mumkin (chimchilab zoom, surib ko'chirish, ikki marta bosish, sichqoncha g'ildiragi, +/− tugmalari, ESC yopish).
