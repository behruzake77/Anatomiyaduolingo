...
**Vizual qamrov**: har bir darsda rasmli kirish slaydi + **46 ta rasmli savol** (img turi). Suyaklar bo'limida (25 dars) har bir darsga **kitobdan (Ahmedov I jild) kesilgan o'z rasmi** berilgan — umumiy skelet emas, aynan o'rganilayotgan suyak (Atlas C1, Axis, dumg'aza...). Shundan **8 tasi ko'ndalang kesma (rang bilan ajratilgan)**. Har bir rasmni bosib **to'liq ekranda kattalashtirib o'qish** mumkin (chimchilab zoom, surib ko'chirish, ikki marta bosish, sichqoncha g'ildiragi, +/− tugmalari, ESC yopish).
