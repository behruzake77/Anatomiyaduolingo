  ...
  lessons: [
    {
      ...
      questions: [
        q({ type: "img", prompt: "Rasmda qaysi skelet qismi ko'rsatilgan?", image: "/img/cross/hand-skeleton.jpg", options: ["Qo'l skeleti (membrum superius)", "Oyoq skeleti", "Ko'krak qafasi", "Chanoq"], answer: 0, difficulty: "easy", hint: "Yelka kamari va qo'lning erkin qismi" }),
  ...
  lessons: [
    {
      ...
      source: { book: "Anatomiya I jild", page: "94–148" },
      questions: [
        q({ type: "img", prompt: "Rasmda qaysi skelet qismi ko'rsatilgan?", image: "/img/cross/facial-skull.jpg", options: ["Kallaning yuz qismi (viscerocranium)", "Kallaning miya qismi", "Bo'yin umurtqalari", "Qovurg'alar"], answer: 0, difficulty: "easy", hint: "Ustki va pastki jag' suyaklari" }),
